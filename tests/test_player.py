...
class PlayerTest(unittest.TestCase):
    def test_stores_name_and_hand(self):
        hand = Hand()
        player = Player(name = "Ivan", hand = hand)
        self.assertEqual(player.name, "Ivan")
    ...
    def test_figures_out_own_best_hand(self):
        ...
        player = Player(name = "Ivan", hand = mock_hand)
    ...
    def test_passes_new_cards_to_hand(self):
        mock_hand = MagicMock()
        player = Player(name = "Jeff", hand = mock_hand)
    ...
    def test_decides_to_continue_or_drop_out_of_game(self):
        player = Player(name = "Elon", hand = Hand())
        self.assertEqual(
